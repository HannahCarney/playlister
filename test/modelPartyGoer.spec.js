...
describe('Party Goer Model', function() {
  ...
  it('should save song choices', function(done) {
    ...
    ['spotify:track:4WrVyBdyZBmAkFOVuWFqTj','spotify:track:2CkE9VvzIzgoJ97h9AcLHW'], function(){
      db.get(pgSongChoice).find({}, {}, function() {
        ...
        doc[0].pgSongChoice.should.equal(['spotify:track:4WrVyBdyZBmAkFOVuWFqTj','spotify:track:2CkE9VvzIzgoJ97h9AcLHW']);
      });
    });
    done();
  });
